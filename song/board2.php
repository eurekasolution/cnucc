...
<body>
  <div class="container mt-5">
    ...
    <table class="table table-hover">
      <thead class="table-dark">
        <tr>
          ...
          <th style="width: 15%;">작업</th> <!-- 답변 버튼 열 추가 -->
        </tr>
      </thead>
      <tbody>
        <?php
        // 예시 게시글 데이터
        $posts = [
            ['title' => '첫번째 질문', 'author' => '홍길동', 'content' => '이것은 첫번째 질문입니다.', 'date' => '2024-10-20'],
            ['title' => '두번째 질문', 'author' => '이몽룡', 'content' => '두번째 질문입니다.', 'date' => '2024-10-19'],
        ];
        ...
        foreach ($posts as $index => $post) {
            echo "<tr>
                    ...
                    <td>{$post['date']}</td>
                    <td>
                      <button class='btn btn-outline-success btn-sm'>답변</button> <!-- 답변 버튼 추가 -->
                    </td>
                  </tr>";
        }
        ?>
    ...
    <div class="d-flex justify-content-between">
      <a href="write.php" class="btn btn-secondary" style="height: auto; width: auto; padding: 5px 15px;">질문하기</a>
